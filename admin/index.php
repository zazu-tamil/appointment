...
<body>
    ...
    <div class="container">
        ...
        <tr class="menu-row">
            <td class="menu-btn menu-icon-doctor ">
                <a href="art-palette.php" class="non-style-link-menu ">
                    <div>
                        <p class="menu-text">Art Palette</p>
                </a>
    </div>
    ...
    <tr class="menu-row">
        <td class="menu-btn menu-icon-patient">
            <a href="art-intern.php" class="non-style-link-menu">
                <div>
                    <p class="menu-text">Art Intern</p>
            </a></div>
        </td>
    </tr>
    </table>
        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;">
            ...
            <tr>
                ...
                <td colspan="2" class="nav-bar">
                    ...
                    <form action="art-palette.php" method="post" class="header-search">
